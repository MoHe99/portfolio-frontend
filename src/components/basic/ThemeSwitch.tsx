  ...
  return (
    <>
      ...
      >
        ...
        <Checkbox.Control class="relative w-11 h-6 bg-neutral-800 dark:bg-neutral-100 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-neutral-600 dark:peer-focus:ring-neutral-400 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-neutral-100 dark:after:bg-neutral-800 after:border-neutral-100 dark:after:border-neutral-800 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-neutral-100">
